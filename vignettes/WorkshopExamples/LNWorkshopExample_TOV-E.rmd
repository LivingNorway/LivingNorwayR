...
# TODO: Replace this section with call to devtools::install_github
...
# library(zip)
# library(emld)
# rFilesLoc <- file.path(Sys.getenv("WORKSPACE_LIVINGNORWAY"), "R")
# importSourceFiles <- sapply(X = file.path(rFilesLoc, dir(rFilesLoc, "*.R")), FUN = source)
# load(file.path(rFilesLoc, "sysdata.rda"))
```
...
A very simple minimal example of the use of markdown to generate create metadata documentation can be found at

```{r CreateMetadata2}
# Initialise the metadata from the R markdown file hosted at TODO
createdTOVEMetadata <- initializeDwCMetadata("C:/Users/joseph.chipperfield/OneDrive - NINA/Work/LivingNorway/LivingNorwayR_GitHub/vignettes/WorkshopExamples/LNWorkshopExample_TOV-E_Metadata.rmd",

...
tb<-data.frame("Package"=c("EML","emld", "RNeXML", "datapack", "rbefdata",
                           ...
                           "MetaInbase", "LivingNorwayR", "NPSdataverse",
               ...
               "Package_description"=c(packageDescription(pkg = "EML")$Description,
                                       ...
                                       packageDescription("MetaInbase")$Description,
...
report7 <- CreatePackageReport(pkg_name = "geometa",
                               report_path = here::here("LivNoR/Pkgnet_out/geometa.html"))
...
report10 <- CreatePackageReport(pkg_name = "MetaInbase",
                                report_path = here::here("Pkgnet_out/MetaInbase.html"))
#No dependancies

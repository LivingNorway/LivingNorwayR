...
library(knitr)
tb<-data.frame("Package"=c("EML","emld", "RNeXML", "datapack", "rbefdata", "geometa", "MetaEgress", "EMLassemblyline", "MetaInbase", "LivingNorwayR", "NPSdataverse", "EMLeditor", "DPchecker", "NPSutils"),

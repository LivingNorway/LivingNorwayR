...
vignette: >
  ...
  %\VignetteIndexEntry{Handling Darwin Core Files With Living Norway:  Example Using the TOV-E Dataset}
...
# TOVEOccTable is an object of type GBIFOccurrence which is derived from DwCGeneric
class(TOVEOccTable)
...
It is also possible to look at the entire EML file in a separate browser by running the following code:
